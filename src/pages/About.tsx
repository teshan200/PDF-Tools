      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xs space-y-6 transition-colors duration-200">
        <div className="border-b border-slate-100 dark:border-slate-800 pb-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-base leading-relaxed">
            A free, privacy-first PDF utility suite engineered to make document editing, signing, and conversion fast, unrestricted, and transparent.
          </p>
        </div>
        ...
        <div className="space-y-4 text-slate-700 dark:text-slate-300 text-sm sm:text-base leading-relaxed">
          ...
          <p>
            Most online PDF websites force users to upload confidential files to unknown cloud servers, lock essential features behind paywalls, or limit daily document edits.
          </p>
          <p>
            <strong>Easy PDF Tools</strong> was engineered by software developer <strong>Teshan Pamodya</strong> to provide an alternative: a high-performance web suite where core utilities (including <strong>PDF Signing, Text Editing, Merging, Splitting, Rotating, and JPG Extraction</strong>) execute <strong>100% locally inside your web browser</strong> — with zero server uploads and complete open-source transparency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
          <div className="p-5 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2">
            ...
            <h3 className="font-bold text-slate-900 dark:text-white text-sm">Client-Side First</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Core editing and signing tools run in browser RAM with zero document uploads across the wire.
            </p>
          </div>
          <div className="p-5 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2">
            <div className="w-8 h-8 rounded-lg bg-slate-200/80 dark:bg-slate-700 text-slate-700 dark:text-slate-300 flex items-center justify-center font-bold text-xs">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              The full codebase is publicly accessible on GitHub for transparency and security auditing.
            </p>
          </div>
          <div className="p-5 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2">
            <div className="w-8 h-8 rounded-lg bg-slate-200/80 dark:bg-slate-700 text-slate-700 dark:text-slate-300 flex items-center justify-center font-bold text-xs">
            ...
            <h3 className="font-bold text-slate-900 dark:text-white text-sm">No Paywalls</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Unlimited file sizes, zero account creation required, and free access for users worldwide.
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 dark:bg-slate-800 text-white rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 border border-transparent dark:border-slate-700">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Software Developer • Portfolio &amp; Open Source</p>
          </div>
