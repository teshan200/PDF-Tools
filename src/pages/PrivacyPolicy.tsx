    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-xs space-y-8 transition-colors duration-200">
        ...
        <section className="space-y-3 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          ...
          <p>
            At <strong>Easy PDF Tools</strong> (accessible at <a href="https://easypdftools.xyz" className="text-blue-600 dark:text-blue-400 hover:underline">https://easypdftools.xyz</a>), we believe privacy is a fundamental human right. Our web application is architected around a <strong>zero-knowledge, client-side processing model</strong>. 
          </p>
          <p>
        ...
        <section className="space-y-3 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">3. Google Analytics &amp; Cookies</h2>
          <p>
        ...
        <section className="space-y-3 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">4. Google AdSense &amp; Third-Party Advertising</h2>
          <p>
        ...
        <section className="space-y-3 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">5. GDPR &amp; CCPA Privacy Rights</h2>
          <p>
        ...
        <section className="space-y-3 text-slate-700 dark:text-slate-300 text-sm leading-relaxed border-t border-slate-100 dark:border-slate-800 pt-6">
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">6. Open Source Transparency &amp; Contact</h2>
          <p>
